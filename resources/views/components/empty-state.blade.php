...
<div class="flex flex-col items-center justify-center text-center py-12 px-4">
    <div class="w-16 h-16 rounded-full bg-marena-sage-mist flex items-center justify-center mb-4">
        <svg class="w-8 h-8 text-marena-teal-soft" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><path d="{{ $icon }}"/></svg>
    </div>
    @if($title)
